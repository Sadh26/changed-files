		...
		<Item Name="Source" Type="Folder">
			<Item Name="Customer" Type="Folder">
				<Item Name="Tests" Type="Folder">
					...
					<Item Name="Database Tests.lvlib" Type="Library" URL="../Tests/Database Tests.lvlib"/>
					<Item Name="test_data.txt" Type="Document" URL="../Tests/test_data.txt"/>
				</Item>
				<Item Name="Typedefs" Type="Folder">
					<Item Name="AccountDetails.ctl" Type="VI" URL="../Typedefs/AccountDetails.ctl"/>
					<Item Name="CaseSelecting.ctl" Type="VI" URL="../Typedefs/CaseSelecting.ctl"/>
				</Item>
				<Item Name="DatabaseSearching.vi" Type="VI" URL="../DatabaseSearching.vi"/>
