...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="source" Type="Folder">
			<Item Name="BubbleSort" Type="Folder">
				<Item Name="Tests" Type="Folder">
					<Item Name="BubbleSort Tests.lvlib" Type="Library" URL="../Tests/BubbleSort Tests.lvlib"/>
				</Item>
				<Item Name="Typedefs" Type="Folder">
					<Item Name="SortType.ctl" Type="VI" URL="../Typedefs/SortType.ctl"/>
				</Item>
				<Item Name="BubbleSort.vi" Type="VI" URL="../BubbleSort.vi"/>
				<Item Name="BubbleSortUsingInplaceElementStructure.vi" Type="VI" URL="../BubbleSortUsingInplaceElementStructure.vi"/>
