...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Source" Type="Folder">
			<Item Name="MechanicalActions" Type="Folder">
				<Item Name="Tests" Type="Folder">
					<Item Name="Mechanical Actions Tests.lvlib" Type="Library" URL="../Tests/Mechanical Actions Tests.lvlib"/>
				</Item>
				<Item Name="Drona.ini" Type="Document" URL="../Drona.ini"/>
				<Item Name="SwitchMechanicalActions.vi" Type="VI" URL="../SwitchMechanicalActions.vi"/>
			</Item>
		</Item>
