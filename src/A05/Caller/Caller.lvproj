...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Source" Type="Folder">
			<Item Name="Caller" Type="Folder">
				<Item Name="Tests" Type="Folder">
					<Item Name="CallerCalledTests.lvlib" Type="Library" URL="../Tests/CallerCalledTests.lvlib"/>
					<Item Name="Sample Report.jpg" Type="Document" URL="../Tests/Sample Report.jpg"/>
					<Item Name="test_caller_called.txt" Type="Document" URL="../Tests/test_caller_called.txt"/>
				</Item>
				<Item Name="Called.vi" Type="VI" URL="../Called.vi"/>
